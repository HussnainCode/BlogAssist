...
class Tool extends Component {
	...
	@observable currentOption = "Utiliser"
    ...
    sanitizeAllPrompts = () => {
        this.prompts[this.currentPrompt].prompts.forEach((prompt) => {
            ...
            if(filterBadWords.isProfane(prompt.value)){
                prompt.error = "Contenu innaproprié, veuillez reformuler."
            ...
            return(
                ...
                <Header 
                    ...
                    options={[
                        ...
                        { title: "Exemple", color: 'yellow', Icon: InformationCircleIcon, onClick: this.onExample},
                    ]}
                                ...
                                {this.prompts.map((prompt, index) => 
                                    ...
                                    <div className="md:flex">
                                        <Countdown 
                                            ...
                                            renderer={props => 
                                            <Button 
                                                title={props.total ? `Attendre ${props.total/1000} secs` : "Envoyer"}
